...
public struct PlatformViewVersionPredicate<SwiftUIViewType: IntrospectableViewType, PlatformSpecificEntity: PlatformEntity> {
    ...
    public static func iOS(_ versions: (PlatformViewVersion<iOSVersion, SwiftUIViewType, PlatformSpecificEntity>)...) -> Self {
        Self(versions, matches: \.isCurrent)
    }

    @_spi(Advanced)
    public static func iOS(_ versions: PartialRangeFrom<PlatformViewVersion<iOSVersion, SwiftUIViewType, PlatformSpecificEntity>>) -> Self {
