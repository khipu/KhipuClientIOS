...
final class SuccessMessageViewTest: XCTestCase {
    ...
    func testSuccessMessageViewRendersCorrectly() throws {
        ...
        let view = SuccessMessageView(operationSuccess: MockDataGenerator.createOperationSuccess(body:"Enviaremos el comprobante  de pago a tu correo",title: "¡Listo, transferiste!"), translator: MockDataGenerator.createTranslator(), operationInfo: MockDataGenerator.createOperationInfo(merchantLogo: "logo",merchantName: "Merchant"), returnToApp: {})
    ...
    func testSuccessMessageViewRendersCMRCorrectly() throws {
        let themeManager = ThemeManager()
