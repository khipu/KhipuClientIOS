// DISABLED: All AuthorizationRequestView tests disabled due to crashes in CI and some local environments
// Related to ViewInspector compatibility issues with AuthorizationRequestView components
// Both tests crash when running in test suites, though they may pass when run individually
